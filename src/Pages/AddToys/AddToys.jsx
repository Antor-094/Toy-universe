  ...
  return (
    <div className="container mx-auto my-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl mx-auto px-2 md:px-0 md:grid gap-4 grid-cols-2">
        ...
        <div className="mb-4">
          <label htmlFor="sellerEmail" className="block mb-2 text-[#1F2937]">Seller Email</label>
        ...
        <div className="mb-4">
          <label htmlFor="subCategory" className="block mb-2 text-[#1F2937]">Sub-category</label>
        ...
        <div className="mb-4 ">
          <label htmlFor="rating" className="block mb-2 text-[#1F2937]">Rating</label>
        ...
        <div className="col-span-2 text-center">
          <button type="submit" className="btn font-bold hover:bg-[#1F2937] w-full">Add Toy</button>
        </div>
      </form>
    </div>
  );
