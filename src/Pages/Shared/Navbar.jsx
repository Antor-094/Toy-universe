    ...
    <nav className="flex items-center justify-between flex-wrap bg-[#e2eff1] p-6">
      ...
      <div className={`w-full spa block flex-grow lg:flex lg:items-center lg:w-auto ${isOpen ? '' : 'hidden'}`}>
       ...
       <div className='flex items-center gap-3'>
        ...
        {
          user? <>
           <div className="flex tooltip   tooltip-bottom items-center" data-tip="hello">
          <img  src="https://i.ibb.co/Wchzp9q/OIG.png" alt="User Profile" className="h-14 w-14 mr-2 rounded-md" />
        </div>
          </>:<></>
        }
       </div>
